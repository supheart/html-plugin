...
<div class="block">
  ...
  <mc-cascader :options="options" v-model="selectedOptions" @change="handleChange"></mc-cascader>
</div>
<div class="block">
  <span class="demonstration">hover 触发子菜单</span>
  <mc-cascader expand-trigger="hover" :options="options" v-model="selectedOptions2" @change="handleChange">
  </mc-cascader>
</div>
...
```html
<mc-cascader :options="optionsWithDisabled"></mc-cascader>
<script>
  export default {
    data() {
      return {
...
```html
<mc-cascader :options="options" :show-all-levels="false"></mc-cascader>
<script>
  export default {
    data() {
      return {
...
```html
<mc-cascader :options="options" v-model="selectedOptions3"></mc-cascader>
<script>
  export default {
    data() {
      return {
...
```html
<mc-cascader :options="options" change-on-select></mc-cascader>
<script>
  export default {
    data() {
      return {
...
```html
<mc-cascader :options="options2" @active-item-change="handleItemChange" :props="props"></mc-cascader>
...
<div class="block">
  ...
  <mc-cascader placeholder="试试搜索：指南" :options="options" filterable></mc-cascader>
</div>
<div class="block">
  <span class="demonstration">可选择任意一级菜单的选项</span>
  <mc-cascader placeholder="试试搜索：指南" :options="options" filterable change-on-select></mc-cascader>
</div>
