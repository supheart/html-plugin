...
```html
<template>
  <mc-button type="text" @click="open">点击打开 Message Box</mc-button>
</template>
...
```html
<template>
  <mc-button type="text" @click="open2">点击打开 Message Box</mc-button>
</template>
...
```html
<template>
  <mc-button type="text" @click="open4">点击打开 Message Box</mc-button>
</template>
...
```html
<template>
  <mc-button type="text" @click="open5">点击打开 Message Box</mc-button>
</template>
...
```html
<template>
  <mc-button type="text" @click="open6">点击打开 Message Box</mc-button>
</template>
...
```html
<template>
  <mc-button type="text" @click="open7">点击打开 Message Box</mc-button>
</template>
...
如果你完整引入了 UI库，它会为 Vue.prototype 添加如下全局方法：$msgbox, $alert 和 $confirm 。因此在 Vue instance 中可以采用本页面中的方式调用 `MessageBox`。调用参数为：
...
```javascript
import { MessageBox } from 'macula-ui';
```

那么对应于上述四个全局方法的调用方法依次为：MessageBox, MessageBox.alert 和 MessageBox.confirm，调用参数与全局方法相同。
...
| showCancelButton          | 是否显示取消按钮                                                                                   | boolean                                                                                                                                                                   | —                                | false（以 confirm 方式调用时为 true） |
